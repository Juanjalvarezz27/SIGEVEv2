...
import { Settings, User, CreditCard, ShieldCheck, HelpCircle } from 'lucide-react';
...
export default function ConfiguracionPage() {
  const [activeTab, setActiveTab] = useState<'perfil' | 'negocio'>('perfil');
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto min-h-screen pb-24">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1 ml-1">Gestiona tu cuenta y las preferencias de tu comercio.</p>
      </div>

      {/* Tabs de Navegación */}
      <div className="flex space-x-1 bg-gray-100 p-1 rounded-xl mb-8 w-fit border border-gray-200">
        <button
