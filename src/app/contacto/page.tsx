    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans selection:bg-indigo-100 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl w-full relative z-10 animate-in fade-in zoom-in duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          {/* Tarjeta WhatsApp (Verde + Indigo sombra) */}
          <a 
          ...
          {/* Tarjeta Email (Full Branding Indigo) */}
          <a 
            href="mailto:jjsalvarezz@gmail.com"
            className="group relative bg-white p-10 rounded-[2rem] shadow-2xl shadow-indigo-900/5 border border-white hover:border-indigo-400 transition-all duration-300 flex flex-col items-center text-center overflow-hidden hover:-translate-y-1"
          >
        ...
        {/* INFO ADICIONAL (Barra Inferior Unificada) */}
